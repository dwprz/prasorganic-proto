...
var (
	...
	file_proto_otp_type_otp_proto_rawDescData = file_proto_otp_type_otp_proto_rawDesc
)

func file_proto_otp_type_otp_proto_rawDescGZIP() []byte {
	file_proto_otp_type_otp_proto_rawDescOnce.Do(func() {
		file_proto_otp_type_otp_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_otp_type_otp_proto_rawDescData)
	})
...
func file_proto_otp_type_otp_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_otp_type_otp_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_proto_otp_type_otp_proto_rawDesc = nil
